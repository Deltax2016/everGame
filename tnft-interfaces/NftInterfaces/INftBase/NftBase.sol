...
abstract contract NftBase is INftBase {
    ...
    function getCODEInfo() external override responsible returns(string code) {
        return {value: 0, flag: 64}(_code);
    }

    function getIcon() external override responsible returns(string icon) {
        return {value: 0, flag: 64}(_icon);
    }
